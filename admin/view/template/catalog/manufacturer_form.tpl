            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <div id="tab-general">
                    <table class="form">
                        ...
                        <tr>
                            <td>Czy chcesz aby opis wyświetlał sie w google</td>
                            <td>
                                <select  name="follow" >
                        ...
                        <tr>
                            <td>Grupa producentów</td>
                            <td><select name="manufacturer_group">
                                    <option></option>
                                    <?php foreach($manufacturer_groups as $group){ ?>
                                        <option value="<?php echo $group['manufacturer_group_id']; ?>"  <?php if($group['manufacturer_group_id'] == $manufacturer_group){ echo 'selected="selected"';  }?> ><?php echo $group['name']; ?></option>
                                    <?php } ?>
                            </select></td>
                        </tr>
                        <tr>
